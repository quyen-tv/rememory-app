...
import searchIcon from '@/assets/icons/ic_search_big.png'
import clearIcon from '@/assets/icons/ic_x_circle.png'
...
const SearchInput = ({ searchValue, onSearchChange, onClear, className }: SearchInputProps) => {
  return (
    <div className='relative'>
      ...
      />
      <img src={searchIcon} alt='Search Icon' className='absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6' />
      {searchValue && (
        <img
          src={clearIcon}
          alt='Clear Icon'
